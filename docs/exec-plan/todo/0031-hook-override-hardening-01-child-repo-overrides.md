# 0031: Hook Override Hardening 01 Child Repo Overrides
...
- This plan can execute in parallel with `0032-hook-override-hardening-02-lifecycle-context.md`.
- `0033-hook-override-hardening-03-sandbox-replay.md` depends on this plan because replay must materialize the selected repo's own effective config.
