...
- **Applied**: All tasks in `/home/yoske/src/github.com/yoskeoka/vibe-coding-workspace`, especially requests involving `ww/`, `ai-arena/`, `reversi-adventure/`, or `vim-learning-game/`.
